...
export default function DataComponent(props) {
    const { Nombre, Carrera, Semestre, Username, Correo, Contrasenia } = props;
    return (
        <View style={{ flexDirection: "column", height: '100%', width: '100%' }}>
            ...
            <View style={{ flexDirection: "row", height: '110%', width: '100%', backgroundColor: '#396371', padding: 20 }}>
                <View style={{ flexDirection: "column", height: '100%', width: '100%', backgroundColor: '#A1C8D2', borderRadius: 20, padding: 5, overflow: 'scroll' }}>
                    ...
                    <TextInput style={styles.textRight} value={Carrera}></TextInput>
                    <Text style={styles.textLeft}>Semestre</Text>
                    <TextInput style={styles.textRight} value={Semestre}></TextInput>
                    <Text style={styles.textLeft}>Nombre de Usuario</Text>
                    <TextInput style={styles.textRight} value={Username}></TextInput>
                    <Text style={styles.textLeft}>Correo</Text>
                    <TextInput style={styles.textRight} value={Correo}></TextInput>
                    <Text style={styles.textLeft}>Contraseña</Text>
                    <TextInput style={styles.textRight} value={Contrasenia}></TextInput>
                </View>
            </View>
        </View>
    );
